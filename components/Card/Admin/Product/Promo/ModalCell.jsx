...
const EditableCell = ({ record, index, children, type, editable, onChange, onBlur, ...restProps }) => {
            ...
            <div>
              <div className="ant-input-group-wrapper">
                <div className="ant-input-wrapper ant-input-group input-group-variant" style={{ zIndex: 1 }}>
                  ...
                  <InputNumber
                    min={record.product["normal_price"].value - (record.product["normal_price"].value * (95/100))}
                    max={record.product["normal_price"].value}
                    ...
                    onBlur={onBlur}
                    onChange={onChange}
                    value={record.product[type].value}
                  />
                </div>
              </div>
  ...
  return(
    <>
      <td {...restProps} className="td-input-variant">{childNode}</td>
    </>
  )
}
